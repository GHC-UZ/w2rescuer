...
// Simulation setup
#define Niter 500       // Number of iterations for screen output
#define DISPLAY 1
...
#define BEDLOAD 1      // Activate bedload transport equation
#define SUSPENDED 0     // Activate suspended transport equation
