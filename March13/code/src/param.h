      ...
      parameter(nmax=80000,dime=4)
      double precision g,pow4,sx,tmpx,theta,Nm
      double precision x,dx,dt,a,b,cfl,t,Tt,dt1,dt2
      double precision q(4,-3:nmax+4),qp(4,-3:nmax+4),q1(4,-3:nmax+4)
      double precision pv(4,-3:nmax+4),pr(4,-3:nmax+4),SWD(-3:NMAX+4)
      double precision qs(4,-3:nmax+4),qphi(4,-3:nmax+4)
      double precision PHI1(NMAX),PHI2(NMAX),PHIP(NMAX)
      double precision F(4,NMAX),F1(4,NMAX),F2(4,NMAX),FP(4,NMAX)
      double precision QM(4,-3:NMAX+4),FT(4,NMAX),por(-3:nmax+4)
      ...
      double precision flp(dime,0:nmax+1),flm(dime,0:nmax+1)
      ...
      double precision qstar(4,-3:nmax+4),lsl,lsr,hh,error2
